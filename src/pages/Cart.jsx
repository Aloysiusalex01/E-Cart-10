          ...
          <table className='table-auto w-full'>
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>Product Name</td>
                <td><img width={'70px'} height={'70px'} src="https://img.freepik.com/free-vector/shopping-supermarket-cart-with-grocery-pictogram
          // _1284-11697.jpg?semt=ais_hybrid" alt="" /></td>
                 <td>
                  <div className='flex'>
